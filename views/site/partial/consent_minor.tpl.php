...
<p>Because you are under age 18, you must complete a special set of consent forms before you can use <?= PIPELINE_NAME ?>. This is required by the Georgia Tech Institutional Review Board (IRB) as part of their <a href="http://www.compliance.gatech.edu/irb-informed-consent/">informed consent protocol</a>.</p>

<p>These forms are linked below. The first form must be completed by you and the second must be completed by a parent. Please print them out, complete them, and send them to the research team. You can either scan them and email the files to <a href="mailto:pipeline@cc.gatech.edu">pipeline@cc.gatech.edu</a> or fax them to (404) 894-3146. <strong>Please include your email address with the forms</strong> or we won't be able to approve your account.</p>

<p>Thanks so much for your patience and we apologize for the inconvenience. We will do everything we can to process these forms quickly and get you using <?= PIPELINE_NAME ?> as soon as possible.</p>
